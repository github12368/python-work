...
def GetLocationInMySQL(TableName,ColuName,PostColuname1,PostColuname2):
    ...
    try:
        ...
        if((conn != None)&(conn2!=None)):
            ...
            ReadCommand = " SELECT * FROM " + TableName # 读取未翻译的记录
            ...
            for i in range(numrows):
                ...
                # UpdateCommand=" update "+TableName+" set "+PostColuname1+'="'+transResult[0]+'" ,'+PostColuname2+'="'+transResult[1]+'" where id='+str(row[0])
