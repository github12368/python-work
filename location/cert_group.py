            ...
            for row in resultall:
                if row[ColuNum]=='' or row[ColuNum]==None:
                    ...
                    try:
                        ...
                        transResult=['0','0']
                print row[ColuNum], transResult[0],transResult[1]
                UpdateCommand=" update "+TableName+" set "+PostColuname1+'="'+transResult[0]+'" ,'+PostColuname2+'="'+transResult[1]+'" where name='+"'"+row[0]+"'"
